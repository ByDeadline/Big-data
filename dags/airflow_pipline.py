...
with DAG(
    ...
    params={
      ...
      "input_dir": Param("gs://TU WPISZ NAZWĘ TWOJEGO ZASOBNIKA/hadoop-intro/projekt/input", type="string"),
      "output_mr_dir": Param("/project1/output", type="string"),
  ...
  mapreduce_classic = BashOperator(
    ...
    bash_command="""hadoop jar {{ params.dags_home }}/project_files/map_reduce6.jar  {{ params.input_dir }}/datasource1 {{ params.output_mr_dir }}""",
  )
...
... """,
  ...
  hive = BashOperator(
    task_id="hive",
    bash_command="""hive \
      -f {{ params.dags_home }}/project_files/projekt_hive.hql \
